...
def setup_home(frame, entry_search, load_neighborhoods, load_styles, list_all, show_frame, frame_neighborhoods, frame_styles, quit_app, load_profile=None, load_route=None):
    ...
    #if load_profile:
        #make_button(frame, "My Profile", load_profile, COLOR_ACCENT, "white").pack(pady=4)
